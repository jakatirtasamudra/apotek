...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="<?= url('/homeadmin/diskon/'.$id); ?>">Ubah</a>
        </li>
    </ol>
</nav>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <a href="<?= url('/homeadmin/diskon') ?>" class="btn btn-danger">
            Kembali
        </a>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-12">
                <form action="<?= url('/homeadmin/diskon/ubahsimpan') ?>" method="POST" enctype="multipart/form-data">
                    <?= $csrf ?>
